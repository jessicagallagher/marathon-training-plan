      ...
      <div className='flex flex-col justify-center'>
        <div className='shadow-2xl overflow-hidden rounded-lg border border-black'>
          <table className='min-w-full'>
            <thead className='bg-[#46BDC6] divide-y divide-black'>
              <tr>
                <th className='text-center text-white text-lg md:text-2xl lg:text-4xl font-bold font-accent md:py-1 lg:py-2'>
